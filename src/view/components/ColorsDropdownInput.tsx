...
export function ColorsDropdownInput({ className, error, placeholder }: ColorsDropdownInputProps) {
      ...
      <DropdownMenu.Trigger>
        ...
        >
          ...
          <span className='absolute right-3 top-1/2 -translate-y-1/2'>
            {selectedColor ? <ColorIcon color={selectedColor.color} bg={selectedColor.bg} /> : !selectedColor && <ChevronDownIcon className='w-6 h-6 text-gray-800' />}
          </span>
        </button>
      </DropdownMenu.Trigger>
